...
# Scope 110 Checklist: Constitutional Sign-Off
...
- [x] All scope 101–109 documents published and cross-linked
...
| Layer | Document | Approx. law count (scope 110) |
|-------|----------|-------------------------------|
...
- Executable semantic tests (same spec IDs) when scopes 112+ / 134+ land
- Full meta-semantics precedence table (scopes 156–158)
- Semantic lint CI (scopes 159–160)
