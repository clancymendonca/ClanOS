...
- Expand scope 131–140 checklists to epoch-1 detail level
- Signed system images + reproducible build CI (BUILD_INTEGRITY)
- Scope **134**: remove interim IPC bridge; CI `ipc_bridge_compat_internal` counter → 0
- P-134 semantic ordering smoke corpus populated at scope 133
