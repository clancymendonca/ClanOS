...
PHASE_RE = re.compile(
    r"Phase60-Integration:\s+procfd=(true|false),\s+dup=(true|false),\s+mprotect=(true|false),\s+mmap=(true|false),\s+writepath=(true|false),\s+multishlib=(true|false),\s+plt=(true|false),\s+digest=(true|false),\s+runq=(true|false),\s+ok=(true|false)"
)
