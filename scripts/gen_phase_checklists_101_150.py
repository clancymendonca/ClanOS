#!/usr/bin/env python3
"""Generate phase-101..150 checklist stubs (one-time doc pass)."""

from pathlib import Path

PHASES = [
    (101, "Compat Syscall ABI Freeze", "governance", "compat", "ABI_SYSCALL.md ares-abi-v1"),
    ...
    (123, "Permission Broker", "platform", "native", "ares-native-v1"),
...
def main() -> None:
    for n, title, layer, tag, deliv in PHASES:
...
""",
    ...
    print(f"wrote {len(PHASES)} checklists to {ROOT}")
