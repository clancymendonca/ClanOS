...
PHASE_RE = re.compile(
    r"Phase80-Integration:\s+sysret=(true|false),\s+chdir=(true|false),\s+munmap=(true|false),\s+wait=(true|false),\s+probe=(true|false),\s+fcntl=(true|false),\s+lazyplt=(true|false),\s+ipi=(true|false),\s+ap=(true|false),\s+ok=(true|false)"
)
