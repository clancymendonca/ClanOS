...
PHASE_RE = re.compile(
    r"Phase90-Integration:\s+sysret=(true|false),\s+getcwd=(true|false),\s+"
    r"chdirprobe=(true|false),\s+vma=(true|false),\s+forkdup=(true|false),\s+"
    r"exec=(true|false),\s+pipe=(true|false),\s+plt=(true|false),\s+ipi=(true|false),\s+"
    r"ok=(true|false)"
)
