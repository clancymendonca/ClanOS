...
PHASE_RE = re.compile(r"Phase65-Ring3Syscall:\s+writepath=(true|false),\s+mprotect=(true|false),\s+ok=(true|false)")
...
def ok(output):
    for line in output.splitlines():
        ...
        if m:
            writepath, mprotect, flag = m.groups()
            return writepath == "true" and mprotect == "true" and flag == "true"
    return False
