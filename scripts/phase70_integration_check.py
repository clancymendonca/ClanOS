...
PHASE_RE = re.compile(
    r"Phase70-Integration:\s+chdir=(true|false),\s+munmap=(true|false),\s+vma=(true|false),\s+fork=(true|false),\s+ring3=(true|false),\s+fcntl=(true|false),\s+lazyplt=(true|false),\s+tlb=(true|false),\s+ap=(true|false),\s+ok=(true|false)"
)
